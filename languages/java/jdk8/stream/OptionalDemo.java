...
public class OptionalDemo {
     public static void main(String[] args) {
        Customer smithCustomer = new Customer(102, "smith", null, Arrays.asList("23456", "78901"));
        ...
        */
        ...
        // Recommended for backend engineering null safety pattern
        ...
        System.out.println(
            smithOfNullableOptional2.orElse("null@email.com")
        );
     ...
     private static Customer getCustomerByEmailId(String emailId){
        List<Customer> customers = CustomerDatabase.getAllCustomers();
        return customers.stream()
                    .filter(customer -> emailId.equals(customer.getEmail()))
                    .findAny()
